#!/usr/bin/env python3
"""
Script para probar el scraper de CDE
"""
...
def test_cde_scraper():
    """Probar el scraper de CDE"""
    try:
        from backend.scrapers.fuentes.cde import CDEScraper
        
        print("🧪 PROBANDO SCRAPER DE CDE")
        print("=" * 50)
        ...
        print(f"❌ Error importando scraper de CDE: {e}")
    except Exception as e:
        print(f"❌ Error probando scraper de CDE: {e}")

def test_cde_scraping_completo():
    """Probar scraping completo de CDE"""
    try:
        from backend.scrapers.fuentes.cde import CDEScraper
        
        print("\n🚀 PROBANDO SCRAPING COMPLETO DE CDE")
        print("=" * 50)
